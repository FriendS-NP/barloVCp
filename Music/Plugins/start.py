...
def start_pannel():
    buttons = [
        [
            InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", url=f"https://t.me/bar_lo0o"),
            InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇs", url=f"https://t.me/bar_lo0o0o"),
        ],
        [
            InlineKeyboardButton("📚 ᴄᴏᴍᴍᴀɴᴅ​ 📚", url="https://telegra.ph/DEV-BARLO-02-20"),
        ],
        [
            InlineKeyboardButton("Owner Source 🧛", url="https://t.me/bar_lo0o0"),
        ],
    ]
    return (
...
pstart_markup = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton(text="✨ sᴜᴘᴘᴏʀᴛ​", url="https://t.me/bar_lo0o"),
            InlineKeyboardButton("✨ ᴜᴘᴅᴀᴛᴇs", url=f"https://t.me/bar_lo0o0o"),
        ],
        [
            InlineKeyboardButton("📚 ᴄᴏᴍᴍᴀɴᴅ ​📚", url="https://telegra.ph/DEV-BARLO-02-20"),
        ],
        ...
        try:
            if member.id in OWNER:
                return await message.reply_text(
                    f"💡 My King [{member.mention}] baru saja bergabung di grup ini."
                )
